...
public static class TaskTrackingSystemEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE TaskTrackingSystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
